...
class Slider:
    ...
    def resize(self, sc_size):
        ...
        self.button_size = (max(self.rectangle_bar.width * 0.04, 10), max(self.rectangle_bar.height * 1.5, 30))
        self.button_position = (
            self.rectangle_bar.left - self.rectangle_bar.width * 0.04 / 2,
            self.rectangle_bar.centery - self.rectangle_bar.height * 1.5 / 2,
        )

        self.button_rect = pygame.Rect(self.button_position, self.button_size)
